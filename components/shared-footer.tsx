      ...
      <div style={{ position: 'relative', maxWidth: '1100px', margin: '0 auto', padding: '3rem 1.5rem 2rem' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
            ...
            >
              ...
              >
                <Image src="/aiwisdom_dev.png" alt="AI Wisdom logo" width={38} height={38} style={{ objectFit: 'contain' }} priority />
              </div>
              <div>
                <div
                  style={{
            ...
            >
              AI architecture patterns, engineering guides, model evaluations, and hands-on experiments — go deeper on the algorithms you just
              visualized.
            </p>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <Image src="/aiwisdom_icon.png" alt="" width={16} height={16} aria-hidden style={{ opacity: 0.4, objectFit: 'contain' }} />
